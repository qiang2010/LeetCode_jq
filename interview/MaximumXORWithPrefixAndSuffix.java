 ...
 *  Solution:
 *  Using TrieTree to find 
 * @author jq
 *
 */
public class MaximumXORWithPrefixAndSuffix {
	
	public static void main(String[] args) {
		MaximumXORWithPrefixAndSuffix dd = new MaximumXORWithPrefixAndSuffix();
//		long []  nums = {4,5,6,23,44,100000000000L,1L<<33,(1L<<36+1L<<29+1L<<1)};
		long []  nums = {11111111111111111L,23};
		System.out.println(dd.maximumXorWithPrefixAndSuffix(nums));
		System.out.println(dd.validataion(nums));
		System.out.println((1L<<39) >= 1e12);
